...
對應 [spec.md](spec.md) 附錄 A（A2 到 A7 章）。每張圖只畫會改變工單或畫面的步驟。

六個情境在 spec.md 的 User Scenarios 中已排定優先序：情境一 / 二 / 三為 P1，情境四 / 五為 P2，情境六為 P3。

---

## 總覽

六個情境不是六條互不相關的路。前四條都在產線 A 的同一張單上分岔，第五條換產線證明骨架可重用，第六條證明欄位可設定。
